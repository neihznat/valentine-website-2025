...
const CONFIG = {
    ...
    questions: {
        ...
        second: {
            ...
            nextAtNormalText: "That's not enough! Slide higher! 💕",   // Shown when they click Next at normal level
            nextAtHighText: "Almost there! Go to extreme! 🚀"         // Shown when they click Next at high level
        },
        third: {
