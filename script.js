...
// Kiss counter: persist in localStorage, start at 1 on first Q1 click, double on each Q1 Yes/No
const KISS_COUNTER_KEY = 'valentineKissCount';

function getKissCount() {
    const raw = localStorage.getItem(KISS_COUNTER_KEY);
    return raw === null ? null : parseInt(raw, 10);
}

function setKissCount(value) {
    localStorage.setItem(KISS_COUNTER_KEY, String(value));
